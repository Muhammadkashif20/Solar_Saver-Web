  ...
  return (
    ...
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
       <img src={NavbarImage} className='w-[7rem] hover:cursor-pointer'/>
      </a>
      ...
      <button className="inline-flex items-center mr-5 bg-orange-500 border-0 py-2 px-4 focus:outline-none hover:bg-white text-white  rounded text-base mt-4 md:mt-0 hover:text-orange-400 ">
        Calculate Solar
      </button>
    </div>
  </header>
