const solerSaver = {
  ...
  Tools: {
    ...
    box2: {
      ...
      paragraph: `Minimal training time for ${(
        <br />
    ...
    box4: {
      ...
      paragraph: `Customizable solar sales ${(
        <br />
    ...
    box6: {
      ...
      paragraph: `Smart management features for ${(
        <br />
  ...
  Before_After: {
    ...
    imageBefore:
      "https://solarsaver.vercel.app/assets/before-slider-5RDoAMwp.webp",
    imageAfter:
      "https://solarsaver.vercel.app/assets/after-slider-zGc8hDen.webp",
  },
  EquipmentIndustry: {
  ...
  ReadytoStart: {
    bgImage:
      "https://solarsaver.vercel.app/assets/background-img-DpEZLK0b.webp",
    heading: "READY TO START?",
    paragraph:
      "Our solar power experts will help you find the perfect solution for your home.",
    btn: "Calculate Solar",
  },
};
